...
public class HospitalGUI extends javax.swing.JFrame {
     ...
     */
    Hospital hr;
    HOSPITALDOAIMPL hdi=new HOSPITALDOAIMPL();
    public HospitalGUI() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       hr=hdi.getUserByName(str1);
        System.out.println(hr.getHUSER() +"Name :");
        if(str1.equals(hr.getHUSER())&&str2.equalsIgnoreCase(hr.getHPASS()))
        {
